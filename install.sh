...
echo "  Plasmoid: add via your panel's 'Add Widgets' dialog or the tray's"
echo "  '+' configure button."
echo "  Standalone app: systemctl --user enable --now gloaming-tray.service"
